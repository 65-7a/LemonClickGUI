...
import me.lemon.client.utils.value.NumberValue;
...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.val.getName() + ": " + this.val.getValue() , (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset + 2) * 2 + 5, -1);
