...
import me.lemon.client.module.Module;
...
public class ModeButton extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Mode: " + mod.getMode(), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
		GL11.glPopMatrix();
	}
	...
	public void mouseClicked(int mouseX, int mouseY, int button) {
		if(isMouseOnButton(mouseX, mouseY) && button == 0 && this.parent.open) {
			mod.setMode(mod.getNextMode().getName());
		}
	}
